...
export const roadmapPageConfig = {
  items: [
    ...
    { title: "Midtrans Snap integration", description: "Payment gateway Indonesia #1 dengan webhook verification", status: "shipped" as RoadmapStatus },
    { title: "Doku JOKUL integration", description: "Alternative payment gateway untuk jangkauan lebih luas", status: "shipped" as RoadmapStatus },
