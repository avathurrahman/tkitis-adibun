      ...
      <div className="space-y-8">
        <Section title="1. Data yang Kami Kumpulkan">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>Data pembayaran yang diproses melalui Midtrans atau Doku (kami tidak menyimpan data kartu)</li>
        ...
        <Section title="3. Penyimpanan dan Keamanan Data">
          <p>
            Data akun disimpan di Supabase dengan enkripsi standar industri. Data pembayaran
            diproses langsung oleh Midtrans/Doku dan tidak melewati server kami. Kami menggunakan
            Row Level Security (RLS) untuk memastikan kamu hanya bisa mengakses data milik kamu.
          </p>
        </Section>
        ...
        <Section title="4. Berbagi Data dengan Pihak Ketiga">
          ...
          <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <li>
              <strong>Midtrans / Doku</strong> — pemrosesan pembayaran
            </li>
            <li>
