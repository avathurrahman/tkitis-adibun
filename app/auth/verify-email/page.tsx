      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Kami sudah kirim link verifikasi ke email yang kamu daftarkan. Klik link tersebut untuk
        ...
        <div className="rounded-lg border bg-muted/30 p-4 text-sm text-muted-foreground space-y-2 text-left">
          ...
          <ul className="space-y-1 list-disc list-inside">
            ...
            <li>Tambahkan noreply@kilatkoding.com ke kontak untuk mencegah masuk spam</li>
